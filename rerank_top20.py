...
def main():
    ...
    parser.add_argument("--trec_tag", default="cortex-reRTrank", help="Run tag in TREC file")
    parser.add_argument("--model", default=os.environ.get("CORTEX_MODEL", "snowflake-llama-3.3-70b"))
    ...
    for item in tqdm(lines, desc="Reranking"):
        ...
        try:
            ...
            print(f"[SKIP] qid={qid} - cortex_complete failed: {type(e).__name__}: {e}")
            continue
